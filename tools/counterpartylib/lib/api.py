...
def check_backend_state():
    ...
    #CHANGED time for parsing last block
    if time_behind > 60 * 60 * 10:   # Ten hours .
        raise BackendError('Paicoind is running about {} hours behind.'.format(round(time_behind / 3600)))
